...
public class InputPanelManager {
    ...
    private static final int MOTION_SOFT_KEY_BOARD_INPUT = 7;
    ...
    private static final int MOTION_INPUT = 22;
    ...
    public InputPanelManager bindMotionInputFragment(EmotionKeyboardFragment emotionKeyboardFragment) {
        this.mMotionPanelFragment = emotionKeyboardFragment;
        return this;
    }

    public InputPanelManager bindVoiceBottom(
            View mVoiceBottom,
    ...
    public InputPanelManager bindMotionBottom(View mMotionBottom, final OnMotionClickListenerCallback mOnMotionClickListenerCallBack) {
        this.mMotionBottom = mMotionBottom;
        this.mOnMotionClickListenerCallBack = mOnMotionClickListenerCallBack;
        this.mMotionBottom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (isNotDoubleClick()) {
                    if (isScroll()) {
                        mMotionBottom.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                motionClick();
                            }
