package com.workdance.chatbot.core.widget.button;
...
import com.workdance.chatbot.core.util.ResourceUtils;
...
public class RoundDrawable extends GradientDrawable {
    ...
    public static RoundDrawable fromAttributeSet(Context context, AttributeSet attrs) {
        ...
        ColorStateList colorBg = ResourceUtils.getColorStateListAttrRes(context, typedArray, R.styleable.RoundButton_rb_backgroundColor);
        ColorStateList colorBorder = ResourceUtils.getColorStateListAttrRes(context, typedArray, R.styleable.RoundButton_rb_borderColor);
        int borderWidth = typedArray.getDimensionPixelSize(R.styleable.RoundButton_rb_borderWidth, ResourceUtils.getDimensionPixelSize(context, R.dimen.default_rb_border_width));
        boolean isRadiusAdjustBounds = typedArray.getBoolean(R.styleable.RoundButton_rb_isRadiusAdjustBounds, false);
        int mRadius = typedArray.getDimensionPixelSize(R.styleable.RoundButton_rb_radius, ResourceUtils.getDimensionPixelSize(context, R.dimen.default_rb_radius));
