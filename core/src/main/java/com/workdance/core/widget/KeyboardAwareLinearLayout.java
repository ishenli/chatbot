...
import com.workdance.core.util.ServiceUtil;
...
public class KeyboardAwareLinearLayout extends LinearLayoutCompat {
    ...
    public KeyboardAwareLinearLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        statusBarHeight = ViewUtils.getStatusBarHeight(this.getContext());
    ...
    private int getKeyboardLandscapeHeight() {
        ...
        return ScreenUtils.clamp(keyboardHeight, minCustomKeyboardSize, getRootView().getHeight() - minCustomKeyboardTopMarginLandscape);
    }
    ...
    private int getKeyboardPortraitHeight() {
        ...
        return ScreenUtils.clamp(keyboardHeight, minCustomKeyboardSize, getRootView().getHeight() - minCustomKeyboardTopMarginPortrait);
    }
