...
import com.workdance.core.util.DeviceUtils;
...
import com.workdance.multimedia.util.AngleUtil;
import com.workdance.multimedia.util.CameraParamUtil;
import com.workdance.multimedia.util.CheckPermission;
...
//        }
        ...
        if (DeviceUtils.isHuaWeiRongyao()) {
    ...
    void setErrorLinsenter(ErrorListener errorLisenter) {
        this.errorListener = errorLisenter;
    }
