...
import com.workdance.core.util.ScreenUtils;
import com.workdance.multimedia.R;
import com.workdance.multimedia.camera.listener.CameraListener;
import com.workdance.multimedia.camera.listener.CaptureListener;
import com.workdance.multimedia.camera.listener.ClickListener;
import com.workdance.multimedia.camera.listener.ErrorListener;
import com.workdance.multimedia.camera.listener.TypeListener;
import com.workdance.multimedia.camera.state.CameraMachine;
...
public class CameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder
    ...
    private void initView() {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.fragment_camera_view, this);
        ...
        mSwitchCamera.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                machine.switchTo(mVideoView.getHolder(), screenProp);
            }
        });
        // 拍照 录像
...
//        });
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        Log.i(TAG, "CameraView SurfaceCreated");
        new Thread() {
            @Override
            public void run() {
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        Log.i(TAG, "CameraView SurfaceDestroyed");
        ...
        switch (type) {
            case TYPE_VIDEO:
                ...
                if (mCameraListener != null) {
                    mCameraListener.recordSuccess(videoUrl, firstFrame);
                }
                break;
            case TYPE_PICTURE:
                mPhoto.setVisibility(INVISIBLE);
                if (mCameraListener != null) {
                    mCameraListener.captureSuccess(captureBitmap);
                }
                break;
            case TYPE_SHORT:
                break;
